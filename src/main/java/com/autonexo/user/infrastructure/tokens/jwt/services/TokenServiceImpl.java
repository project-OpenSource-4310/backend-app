package com.autonexo.user.infrastructure.tokens.jwt.services;
...
public class TokenServiceImpl implements BearerTokenService {
    ...
    private String buildTokenWithDefaultParameters(String username) {
        ...
        var expiration = new Date(System.currentTimeMillis() + (30L * 24 * 60 * 60 * 1000)); // 30 días en milisegundos
